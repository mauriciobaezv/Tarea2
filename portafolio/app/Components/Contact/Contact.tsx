      ...
      <div className="container">
        <div className={styles.contact__content}>
          <div className={styles.contact__info}>
            <span className={styles.subtitle}>¿Tienes un proyecto?</span>
            ...
            <div className={styles.contact__data}>
              ...
              <div className={styles.contact__item}>
                ...
                <div className={styles.contact__text}>
                  ...
                  <span className={`${styles.contact__value} ${styles.available}`}>
          ...
          <div className={styles.contact__cta}>
            <div className={styles.contact__card}>
              <h3 className={styles.contact__cardTitle}>¿Listo para comenzar?</h3>
              <p className={styles.contact__cardText}>
                Envíame un mensaje y te responderé lo antes posible.
              </p>

              <a href="mailto:tu@email.com" className={styles.btn}>
